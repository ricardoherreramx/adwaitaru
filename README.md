...
![icon](./Adwaitaru/scalable/apps/gmtpicon.svg "Graphic Media Transfer Protocol (gMTP)")
...
![icon](./Adwaitaru/scalable/apps/org.pitivi.Pitivi.svg "Pitivi")
...
![icon](./Adwaitaru/scalable/mimetypes/text-x-sub.svg "Subtitle File")
